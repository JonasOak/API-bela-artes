...
public class PedidosResource {
    ...
    @GetMapping
    public ResponseEntity<?> getRequestOrder() {
        return ResponseEntity.ok(service.getListProductsRequest());
    }
    @GetMapping("/clients")
    public ResponseEntity<?> getResponseOrderClients() {
        return ResponseEntity.ok(service.getListOrderRequest());
    }
